...
import { Shield, Clock, Award, Users, Globe, CheckCircle, Star, Zap, Target, FileCheck } from 'lucide-react';
...
const WhyChooseUs = () => {
  const features = [
    ...
    {
      icon: Users,
      title: "Experienced Audit Team Across India",
      description: "Our certified auditors have extensive experience in SEDEX SMETA audits across all major industrial sectors in India, ensuring thorough and professional assessment.",
      color: "purple"
    },
    {
      icon: Zap,
